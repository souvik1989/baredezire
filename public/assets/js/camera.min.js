(function (a) {
    a.fn.camera = function (H, V) {
        ...
        if (H.navigation == true) {
            D.append('<div class="camera_prev"><i class="fa fa-chevron-left" aria-hidden="true"></i></div>').append('<div class="camera_next"><i class="fa fa-chevron-right" aria-hidden="true"></i></div>')
        }
