<div class="mb-3">
  <label class="form-label" for="FaqQuestion">Blog Category Name<span class="text-danger">*</span></label>
...
<a class="btn btn-dark" href="{{ route('blog-category.index') }}">Cancel</a>
