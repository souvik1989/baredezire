...
<div class="content-wrapper">
  ...
  <div>
    <a href="{{ route('homeSection3.create') }}" class="btn btn-primary font-weight-bold mb-3">
      + Add New Section
    </a>
  </div>
  ...
  <div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">Home Section 3 Content</h4>
          <hr>
                ...
                @if($sections->count() > 0 )
                  @foreach($sections as $section)
                    <tr>
                      ...
                      <td>
                         <a href="{{ route('homeSection3.edit', $section) }}" class="btn btn-info btn-sm">
