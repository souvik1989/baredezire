<header>
    ...
    <div class="header-bottom d-none d-lg-block d-md-none d-sm-none">
      <div class="container-fluid">
        ...
        <a href="{{route('dashboard')}}" class="navbar-brand"><img src="{{asset('assets/images/logo_new.png')}}" alt=""></a>
        <div class="wish-cart">
          ...
          <a href="{{route('wishlist')}}"><img src="{{asset('assets/images/icon/wishlist.png')}}" alt=""> <p>{{ App\Models\Cart::where('user_id',Auth::check()?Auth::user()->id:0)->where('wishlist',1)->count() }}
                        </p></a>
          <a href="{{route('cartView')}}"><img src="{{asset('assets/images/icon/cart.png')}}" alt=""> <p>@if (Auth::check())
        ...
        @endif
           ...
           @guest
          <a href="{{route('loginForm')}}"><img src="{{asset('assets/images/icon/profile.png')}}"
              alt=""></a>
            @else
           <ul class="navbar-nav ml-auto nav-fill">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle dropdown__toggle" id="navbarDropdown" href="#"
                               ...
                               <img src="{{asset('assets/images/icon/profile.png')}}"
              alt="" class="unique-icon">
    ...
    @foreach ($categories->sortBy('name') as $category)
        ...
        $new_cat_name = strtolower($category->name);
                                      ...
                                      @endphp
                <a class="nav-link dropdown-toggle" href="{{route('maincategory-product',[$category->slug])}}" id="servicesDropdown" role="button" data-toggle="dropdown"
    ...
    <div class="header-last d-none d-lg-block d-md-none d-sm-none">
      <nav class="navbar navbar-light navbar-expand-lg" id="myNavbar">
 ...
 @foreach ($categories->sortBy('name') as $category)
        ...
        $new_cat_name = strtolower($category->name);
                                      ...
                                      @endphp
              <a class="nav-link dropdown-toggle" href="{{route('maincategory-product',[$category->slug])}}" id="servicesDropdown" role="button">{{$category->name }} <span class="sr-only">(current)</span></a>
               @if (count($category->children) !== 0)
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="password" name="old_password" class="form-control @error('old_password') is-invalid @enderror"
                                    id="old_password" placeholder="Enter Existing Password!"
                                     />
                            </div>
                        </div>
