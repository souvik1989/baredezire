...
<section class="order-report-wrap">
  ...
  <form method="POST" name="customerData" action="{{route('payment.initiate')}}">
	 @csrf   
      <div class="container">
        <div class="heading">
          <h2>
        ...
        <table width="50%" height="100" border='1' align="center" class="table table-striped">
				...
				<input type="hidden" name="merchant_id" value="3049383"/>
				...
				<tr>
					...
					<input type="hidden" name="redirect_url" value="{{route('payment.response')}}"/>
				
			 	<input type="hidden" name="cancel_url" value="{{route('payment.response')}}"/>
		...
		{{--<tr>
		        ...
		        <input type="hidden" name="billing_name" value="{{$order->user->ship_address->first_name}} {{$order->user->ship_address->last_name}}"/>
		        
		       <input type="hidden" name="billing_address" value="{{$order->user->ship_address->billing_address_line1}}  {{$order->user->ship_address->billing_address_line2}}"/>
		       
		       <input type="hidden" name="billing_city" value="{{$order->user->ship_address->billing_city}}"/>
		      
		       <input type="hidden" name="billing_state" value="{{$order->user->ship_address->billing_state}}"/>
		        
		       <input type="hidden" name="billing_zip" value="{{$order->user->ship_address->billing_zip}}"/>
		     
		       <input type="hidden" name="billing_country" value="{{$order->user->ship_address->billing_country}}"/>
		   <input type="hidden" name="billing_tel" value="{{$order->user->phone}}"/>
		      
		       <input type="hidden" name="billing_email" value="{{$order->user->email}}"/>
		    
		     {{--   <tr>
		        	<td colspan="2">Shipping information(optional)</td>
		        </tr>
		        <tr>
		        	<td>Shipping Name	:</td><td><input type="text" name="delivery_name" value="{{$order->user->ship_address->first_name}} {{$order->user->ship_address->last_name}}"/></td>
		        </tr>
		        <tr>
		        	<td>Shipping Address	:</td><td><input type="text" name="delivery_address" value="{{$order->user->ship_address->shipping_address_line1}} , {{$order->user->ship_address->shipping_address_line2}}"/></td>
		        </tr>
		        <tr>
		        	<td>shipping City	:</td><td><input type="text" name="delivery_city" value="{{$order->user->ship_address->shipping_city}}"/></td>
		        </tr>
		        <tr>
		        	<td>shipping State	:</td><td><input type="text" name="delivery_state" value="{{$order->user->ship_address->shipping_state}}"/></td>
		        </tr>
		        <tr>
		        	<td>shipping Zip	:</td><td><input type="text" name="delivery_zip" value="{{$order->user->ship_address->shipping_zip}}"/></td>
		        </tr>
		        <tr>
		        	<td>shipping Country	:</td><td><input type="text" name="delivery_country" value="{{$order->user->ship_address->shipping_country}}"/></td>
		        </tr>
		        <tr>
		        	<td>Shipping Tel	:</td><td><input type="text" name="delivery_tel" value="{{$order->user->phone}}"/></td>
		        </tr>
		       <tr>
...
<!-- <script src="jquery-1.7.2.min.js"></script>-->
 <script language="javascript" type="text/javascript" src="{{asset('paymentAsset/json.js')}}"></script>
 <script src="{{asset('paymentAsset/jquery-1.7.2.min.js')}}"></script>
