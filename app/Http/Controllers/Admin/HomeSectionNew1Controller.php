...
class HomeSectionNew1Controller extends Controller
{
    /**
    ...
    {
        $data['sections'] = HomeSection1New::all();
        return view('admin.homeSection.sectionNew1.list', $data);
    }
    ...
    {
        return view('admin.homeSection.sectionNew1.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $section = new HomeSection1New();
        $section->fill($values);
        $section->save();

        $notify[] = ['success', __('admin_messages.record.add')];
        return redirect()->route('homeSectionNew1.index')->withNotify($notify);
    }
    ...
    {
        $data['section'] = HomeSection1New::find($id);
        return view('admin.homeSection.sectionNew1.edit', $data);
    }
    ...
    {
         $changed = false;
        $section = HomeSection1New::find($id);
        $values = $request->validate([
            "image"=>'nullable|image|max:5000',
    ...
    {
      $homeBanner=HomeSection1New::find($id);
         if (isset($homeBanner)) {
