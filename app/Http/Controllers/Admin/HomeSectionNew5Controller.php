...
class HomeSectionNew5Controller extends Controller
{
    /**
    ...
    {
        $data['sections'] = HomeSection5New::all();
        return view('admin.homeSection.sectionNew5.list', $data);
    }
    ...
    {
        return view('admin.homeSection.sectionNew5.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $section = new HomeSection5New();
        $section->fill($values);
        $section->save();

        $notify[] = ['success', __('admin_messages.record.add')];
        return redirect()->route('homeSectionNew5.index')->withNotify($notify);
    }
    ...
    {
        $data['section'] = HomeSection5New::find($id);
        return view('admin.homeSection.sectionNew5.edit', $data);
    }
    ...
    {
         $changed = false;
        $section = HomeSection5New::find($id);
        $values = $request->validate([
            "image"=>'nullable|image|max:5000',
    ...
    {
        $homeBanner=HomeSection5New::find($id);
         if (isset($homeBanner)) {
