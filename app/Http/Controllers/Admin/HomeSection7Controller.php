...
class HomeSection7Controller extends Controller
{
    ...
    {
        $data['sections'] = Home7Section::all();
        return view('admin.homeSection.section7.list', $data);
    }
    ...
    {
        return view('admin.homeSection.section7.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $section = new Home7Section();
        $section->fill($values);
        $section->save();

        $notify[] = ['success', __('admin_messages.record.add')];
        return redirect()->route('homeSection7.index')->withNotify($notify);
    }
    ...
    {
        $data['section'] = Home7Section::find($id);
        return view('admin.homeSection.section7.edit', $data);
    }
